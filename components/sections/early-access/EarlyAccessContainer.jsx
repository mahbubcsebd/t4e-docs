    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
      ...
      {step > 1 && (
        <div className="mb-8 flex items-center justify-between">
          <button
            onClick={handleBack}
            className="flex items-center text-sm font-semibold text-gray-400 hover:text-[#5c67f2] transition-colors uppercase tracking-wider"
          >
      ...
      {step === 1 && <SegmentSelector onSelect={handleSegmentSelect} />}
